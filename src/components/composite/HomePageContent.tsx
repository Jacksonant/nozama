  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 lg:py-8">
      <div className="flex gap-6">
        {/* Desktop Sidebar */}
        <aside className="hidden md:block w-64 flex-shrink-0" role="complementary" aria-label="Product filters">
        ...
        <div className="flex-1">
          <div className="flex justify-between items-center mb-4 lg:mb-6">
            <h1 className="text-xl lg:text-2xl font-bold" role="heading" aria-level={1}>
              {filters.search
          ...
          {loading && products.length === 0 ? (
            ...
            <>
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4 lg:gap-6" role="grid" aria-label="Product listings">
